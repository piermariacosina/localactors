...
case Padrino.env
  ...
  when :production then DataMapper.setup(:default, ENV["HEROKU_POSTGRESQL_YELLOW_URL"])
  when :staging then DataMapper.setup(:default, ENV["HEROKU_POSTGRESQL_YELLOW_URL"])
